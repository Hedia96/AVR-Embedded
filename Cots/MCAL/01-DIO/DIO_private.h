 ...
 */
#define   DDRA ((Register*) DDRA_ADDRESS)->ByteAccess
#define   DDRB ((Register*) DDRB_ADDRESS)->ByteAccess
#define   DDRC ((Register*) DDRC_ADDRESS)->ByteAccess
#define   DDRD ((Register*) DDRD_ADDRESS)->ByteAccess


#define   PORTA ((Register*) PORTA_ADDRESS) ->ByteAccess
#define   PORTB ((Register*) PORTB_ADDRESS) ->ByteAccess
#define   PORTC ((Register*) PORTC_ADDRESS)->ByteAccess
#define   PORTD ((Register*) PORTD_ADDRESS)->ByteAccess



#define   PINA ((Register*) PINA_ADDRESS) ->ByteAccess
#define   PINB ((Register*) PINB_ADDRESS) ->ByteAccess
#define   PINC ((Register*) PINC_ADDRESS) ->ByteAccess
#define   PIND ((Register*) PIND_ADDRESS) ->ByteAccess
